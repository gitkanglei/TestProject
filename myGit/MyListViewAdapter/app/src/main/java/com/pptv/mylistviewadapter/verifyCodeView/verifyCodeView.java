...
public class verifyCodeView extends View
{
    ...
    private void initAttrValues(Context context, AttributeSet attrs)
    {
        ...
        mCodeTextSize = typedArray.getDimensionPixelSize(R.styleable.VerifyCode_VerifyCode_codeTextSize,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 16, getResources().getDisplayMetrics()));
        mCodeBackground = typedArray.getColor(R.styleable.VerifyCode_VerifyCode_codeBackground, Color.WHITE);
        mCodeLength = typedArray.getInteger(R.styleable.VerifyCode_VerifyCode_codeLengt, 4);
        isContainChar = typedArray.getBoolean(R.styleable.VerifyCode_VerifyCode_isContainChar, true);
        mPointNum = typedArray.getInteger(R.styleable.VerifyCode_VerifyCode_pointNum, 100);
        mLineNum = typedArray.getInteger(R.styleable.VerifyCode_VerifyCode_linNum, 3);
        typedArray.recycle();
    }
    ...
    private static void drawPoint(Canvas canvas, Paint paint)
    {
        ...
        paint.setARGB(255, mRandom.nextInt(200) + 20, mRandom.nextInt(200) + 20, mRandom.nextInt(200) + 20);
