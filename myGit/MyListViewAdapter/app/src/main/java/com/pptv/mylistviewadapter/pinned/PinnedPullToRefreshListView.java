 ...
 */
package com.pptv.mylistviewadapter.pinned;
 ...
 * @since [产品/模块版本]
 */
public class PinnedPullToRefreshListView extends ListView
{

    // -- inner classes

    /**
     * List adapter to be implemented for being used with
     * PinnedSectionListView adapter.
     */
    ...
    private final AbsListView.OnScrollListener mOnScrollListener = new AbsListView.OnScrollListener()
    {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount)
        {
            ...
            android.util.Log.i("pptrl-", "is first visible item => " + isFirstVisibleItemSection + "---"
                    + adapter.getItemViewType(firstVisibleItem));
            ...
            if (isFirstVisibleItemSection)
            {
                ...
                { // section doesn't stick to the top, make sure we have a
                  // pinned shadow
            ...
            { // section is not at the first visible position
                ...
                { // there is no section for the first visible item, destroy
                  // shadow
                    destroyPinnedShadow();
                }
            }
    ...
    public PinnedPullToRefreshListView(Context context, AttributeSet attrs, int defStyle)
    {
    ...
    void createPinnedShadow(int position)
    {
        ...
        {
            layoutParams = new AbsListView.LayoutParams(AbsListView.LayoutParams.WRAP_CONTENT,
        ...
        // measure & layout
        int ws = View.MeasureSpec.makeMeasureSpec(getWidth() - getListPaddingLeft() - getListPaddingRight(),
